 ...
 *
 * This site sets NO cookies at all: theme and currency live in localStorage,
 * there is no analytics script, no advertising pixel and no third-party
 * embed that could set one. There is therefore nothing to obtain consent FOR,
 * and a banner with "Accept"/"Reject" buttons would be theatre — it would imply
 * tracking exists and train the visitor to click through real consent prompts.
 *
  ...
  return (
    <div className="fixed inset-x-3 bottom-3 z-50 mx-auto max-w-lg rounded-xl border border-line-strong bg-surface-1 p-3.5 shadow-raised sm:inset-x-auto sm:right-4">
      <p className="text-[12.5px] leading-relaxed text-ink-muted">
        <strong className="font-semibold text-ink">No cookies, no tracking.</strong> This site stores your theme and
        currency choice in your browser&apos;s local storage and nothing else. No analytics, no ads, no third parties.{" "}
